...
int main()
{
	int rt;
	HideCursor(); //隐藏控制台的光标 
	HWND hwnd = FindWindowA("ConsoleWindowClass", NULL);/*  控制台窗口句柄 */
	...
	while (1){
		...
		case MOUSE_EVENT:
		{
							...
							switch (rt){
							case 1:
								MessageBoxA(hwnd, "双击操作", "111", 0);
								break;
							case 2:
								MessageBoxA(hwnd, "右键单击", "222", 0);
								break;
							case 3:
								MessageBoxA(hwnd, "左键单击第一行", "333", 0);
								break;
							case 4:
								MessageBoxA(hwnd, "左键单击第二行", "444", 0);
								break;
							}
		}
			break;
